...
def main():
    ...
    # 检查是否加载了所有图片
    expected_total = 4000 * 2  # real + fake
    ...
    # 从 test_dataset 中创建 real 和 fake 的子集
    ...
    # 对抗攻击评估
    # 定义对抗攻击 - 使用 CW 攻击
    # CW攻击的参数可能需要根据具体情况进行调整
    # 这里设置了一个示例参数，您可以根据需要进行修改
    attack_real = torchattacks.CW(model, c=1, kappa=0, steps=1, lr=0.008)
    attack_fake = torchattacks.CW(model, c=1, kappa=0, steps=1, lr=0.008)
